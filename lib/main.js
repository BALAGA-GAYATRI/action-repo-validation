...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var secret_token, octokit, repositories, repositories_list, ownername, repository, validationResult, i, validationResultRepo, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    ...
                    result = JSON.parse(JSON.stringify(validationResult, null, '\t'));
